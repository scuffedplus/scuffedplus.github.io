...
// oneko.js petting fork: https://github.com/tylxr59/oneko.js
...
(function oneko() {
  ...
  function init() {
    ...
    nekoEl.style.left = `${nekoPosX - 24}px`;
    nekoEl.style.top = `${nekoPosY - 24}px`;
  ...
  function explodeHearts() {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      heart.style.left = `${centerX + offsetX - 24}px`;
      heart.style.top = `${centerY + offsetY - 24}px`;
  ...
  function frame() {
    ...
    nekoPosX = Math.min(Math.max(24, nekoPosX), window.innerWidth - 24);
    nekoPosY = Math.min(Math.max(24, nekoPosY), window.innerHeight - 24);
